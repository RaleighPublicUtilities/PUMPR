(function(){
  ...
  angular
    ...
    ProjectCtrl.$inject = ['$scope', '$location', '$timeout', 'agsServer', 'leafletData', 'Auth', 'search', 'mapLayers'];

  function ProjectCtrl($scope, $location, $timeout, agsServer, leafletData,  Auth, search, mapLayers) {
    var self = this;
